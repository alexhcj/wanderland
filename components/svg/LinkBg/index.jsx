import s from './linkBg.module.css'

export const LinkBg = ({ width, height, fill, bgColor }) => {
	return (
		<span className={s.linkItemBg}>
			...
			<span className={`${s.linkBgCenter} ${s.tag}`}></span>
			<svg
...
// TODO: refactor. customizible props. through attributes + classnames different types